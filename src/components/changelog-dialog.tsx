    ...
    return parts.map((part, i) => {
      ...
      if (part.type === "pr") {
        return (
          <button
            key={i}
            onClick={() => openUrl(`https://github.com/FrankieeW/openusage/pull/${part.content.slice(1)}`).catch(console.error)}
            className={linkClass}
          >
            {part.content}
          </button>
      ...
      if (part.type === "commit") {
        return (
          <button
            key={i}
            onClick={() => openUrl(`https://github.com/FrankieeW/openusage/commit/${part.content}`).catch(console.error)}
              ...
              {releases.length >= 1 && (
                <div className="mt-8 pt-6 border-t border-dashed">
                  <p className="text-[10px] text-muted-foreground text-center">
                    ...
                    <button 
                      onClick={() => openUrl("https://github.com/FrankieeW/openusage/releases").catch(console.error)}
